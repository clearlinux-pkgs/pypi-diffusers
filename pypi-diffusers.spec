...
Version  : 0.29.2
Release  : 49
URL      : https://files.pythonhosted.org/packages/15/bc/5a408779c6704cd60d07758bf15931c581214549c1b197203f4989b36ac6/diffusers-0.29.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/15/bc/5a408779c6704cd60d07758bf15931c581214549c1b197203f4989b36ac6/diffusers-0.29.2.tar.gz
...
%prep
%setup -q -n diffusers-0.29.2
cd %{_builddir}/diffusers-0.29.2
pushd ..
cp -a diffusers-0.29.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719504315
