...
Version  : 0.17.1
Release  : 11
URL      : https://files.pythonhosted.org/packages/99/0a/e7ae4a69859117d622349aebe47146e26354607a36092d2a0676e0fd4ddb/diffusers-0.17.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/99/0a/e7ae4a69859117d622349aebe47146e26354607a36092d2a0676e0fd4ddb/diffusers-0.17.1.tar.gz
Summary  : Diffusers
...
%prep
%setup -q -n diffusers-0.17.1
cd %{_builddir}/diffusers-0.17.1
pushd ..
cp -a diffusers-0.17.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686582644
