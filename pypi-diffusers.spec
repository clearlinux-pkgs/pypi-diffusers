...
Version  : 0.22.0
Release  : 26
URL      : https://files.pythonhosted.org/packages/41/7f/669c9f2d508ac25f3ff07d70720354578c551a5402315770dcdecf3e2f5b/diffusers-0.22.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/41/7f/669c9f2d508ac25f3ff07d70720354578c551a5402315770dcdecf3e2f5b/diffusers-0.22.0.tar.gz
...
%prep
%setup -q -n diffusers-0.22.0
cd %{_builddir}/diffusers-0.22.0
pushd ..
cp -a diffusers-0.22.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699284849
