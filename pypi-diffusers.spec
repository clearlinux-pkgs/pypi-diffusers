...
Source0  : https://files.pythonhosted.org/packages/ec/6f/37aaeff725b49ee818891f6cc8cde03174bc2fb1e045a0a020ad564efa4e/diffusers-0.21.3.tar.gz
...
%prep
%setup -q -n diffusers-0.21.3
cd %{_builddir}/diffusers-0.21.3
pushd ..
cp -a diffusers-0.21.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695915086
