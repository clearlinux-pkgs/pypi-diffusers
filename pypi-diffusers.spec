...
Version  : 0.34.0
Release  : 67
URL      : https://files.pythonhosted.org/packages/34/01/eee276cb1ffa1528d3fac8c8382c32d0deef7f089baeefbee254bbbc0a8f/diffusers-0.34.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/34/01/eee276cb1ffa1528d3fac8c8382c32d0deef7f089baeefbee254bbbc0a8f/diffusers-0.34.0.tar.gz
...
%prep
%setup -q -n diffusers-0.34.0
cd %{_builddir}/diffusers-0.34.0
pushd ..
cp -a diffusers-0.34.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750863086
