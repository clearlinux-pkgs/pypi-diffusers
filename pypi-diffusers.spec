...
Version  : 0.26.2
Release  : 39
URL      : https://files.pythonhosted.org/packages/1f/bd/779ee45acb188128f42e6a36453309673f0b91cc11c76d2db76c3793bc9d/diffusers-0.26.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/1f/bd/779ee45acb188128f42e6a36453309673f0b91cc11c76d2db76c3793bc9d/diffusers-0.26.2.tar.gz
...
%prep
%setup -q -n diffusers-0.26.2
cd %{_builddir}/diffusers-0.26.2
pushd ..
cp -a diffusers-0.26.2 buildavx2
popd
pushd ..
cp -a diffusers-0.26.2 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707234535
